...
public class TestParquetFileWriter {
  ...
  public void testWriteRead() throws Exception {
    ...
    { // read first block of col #1
      ParquetFileReader r = new ParquetEmbeddedTableFileReader(configuration, path, Arrays.asList(readFooter.getBlocks().get(0)), Arrays.asList(schema.getColumnDescription(path1)));
    ...
    { // read all blocks of col #1 and #2
      ...
      ParquetFileReader r = new ParquetEmbeddedTableFileReader(configuration, path, readFooter.getBlocks(), Arrays.asList(schema.getColumnDescription(path1), schema.getColumnDescription(path2)));
